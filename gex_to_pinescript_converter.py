# ===========================================================
# GEX to Pine Script Converter v3.7 (Tuple Declaration Fix)
# ===========================================================
# Features:
#   ✅ FIX: Uses declaration '=' instead of reassignment ':=' for Main Calls
#   ✅ FIX: Removes redundant global 'var' initializations to prevent scope conflicts
...
print("🌲 Starting Historical GEX Converter (v3.7 - Declaration Fix)...")
...
# FIX 1: Removed global 'var' declarations for plot variables to avoid reassignment errors
...
# FIX 2: Used '=' for declaration instead of ':=' for reassignment
pine_code += "\n// ===== MAIN CALLS =====\n"
...
print(f"✅ Created {output_filename} (v3.7 - Declaration Fix)")
